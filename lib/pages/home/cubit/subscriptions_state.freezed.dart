...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SubscriptionsState<T>);
}
...
/// @nodoc
class $SubscriptionsStateCopyWith<T,$Res>  {
$SubscriptionsStateCopyWith(SubscriptionsState<T> _, $Res Function(SubscriptionsState<T>) __);
}


/// Adds pattern-matching-related methods to [SubscriptionsState].
extension SubscriptionsStatePatterns<T> on SubscriptionsState<T> {
...
class _Initial<T> implements SubscriptionsState<T> {
  const _Initial();
...
class Loading<T> implements SubscriptionsState<T> {
  const Loading();
...
class Success<T> implements SubscriptionsState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $SubscriptionsStateCopyWith<T, $Res> {
...
class Error<T> implements SubscriptionsState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $SubscriptionsStateCopyWith<T, $Res> {
