...
part of 'complaint_api_service.dart';
...
class _ComplaintApiService implements ComplaintApiService {
  _ComplaintApiService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<ComplaintResponseModel> deleteComplaint(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
